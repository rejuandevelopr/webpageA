...
<template>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container">
          <a class="navbar-brand" href="#"><img :src="header.brandimage" alt="Brand-logo"> <span> Nexcent </span> </a>
          ...
          <div class="collapse navbar-collapse nav-main" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#">{{ header.feature }}</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">{{ header.community }}</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" href="#">{{ header.blog }}</a>
              </li>
              <li class="nav-item">
                <a class="nav-link nav__five" href="#">{{ header.pricing }}</a>
              </li>
            </ul>
              <button class="btn btn-primary ms-2">{{ header.register }} <svg width="12" height="12" viewBox="0 0 12 12" fill="#ffffff" xmlns="http://www.w3.org/2000/svg">
              <path d="M8.52576 8.47034L10.2449 6.75123C10.4487 6.54735 10.4487 6.2168 10.2449 6.01292L8.52576 4.29381M10.092 6.38207L2.435 6.38207" stroke="white" stroke-width="0.765676" stroke-linecap="round"/>
              </svg></button>  
          </div>
        </div>
    </nav>
            ...
            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel" data-interval="2000">
                ...
                <div class="carousel-inner">
                  <div class="carousel-item active">
                    <div class="row gy-5">
                        <div class="col-xl-8 hero__content">
                            <h1>{{ hero.h1 }} <br> <span> {{ hero.h1span }} </span></h1>
                            <p>{{ hero.p }}</p>
                            <button class="btn btn-primary">{{ hero.reg }}</button>
                        </div>

                        <div class="col-xl-4">
                            <img class="img-fluid" :src="hero.heroimage" :alt="hero.alt" :title="hero.title">
                        </div>
                    </div>
    ...
    <section class="clients">
        <div class="container">
            <div class="text-center clients__content mt-sm-4">
                <h2>{{ clients.h2 }}</h2>
                <p>{{ clients.p }}</p>
                ...
                <div class="row mt-sm-5">
                    <div class="col-xl-5">
                        <div class="row gy-3">
                            <div class="col-lg-4">
                                <img :src="clients.logo" :alt="clients.alt" :title="clients.title">
                            </div>
                            <div class="col-lg-4">
                              <img :src="clients.logo1" :alt="clients.alt" :title="clients.title">
                            </div>
                            <div class="col-lg-4">
                              <img :src="clients.logo2" :alt="clients.alt" :title="clients.title">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-2 gy-3">
                      <img :src="clients.logo3" :alt="clients.alt" :title="clients.title">
                    </div>
                    <div class="col-xl-5 gy-3">
                        <div class="row gy-3">
                            <div class="col-lg-4">
                              <img :src="clients.logo4" :alt="clients.alt" :title="clients.title">
                            </div>
                            <div class="col-lg-4">
                              <img :src="clients.logo5" :alt="clients.alt" :title="clients.title">
                            </div>
                            <div class="col-lg-4">
                              <img :src="clients.logo6" :alt="clients.alt" :title="clients.title">
                            </div>
    ...
    <section class="community">
        <div class="container">
            <div class="text-center community__content">
                <h2>Manage your entire community <br> in a single system</h2>
                <p>Who is Nextcent suitable for?</p>
            </div>

            <div class="row mt-sm-4 g-3">
                <div class="col-xl-4 text-center">
                     <div class="community__card shadow-sm">
                        <img :src="community[1].icon" alt="community-icon">
                        <h3>{{ community[1].h3one }} <br> {{ community[1].h3two }}</h3>
                        <p>{{ community[1].p1 }} <br> {{ community[1].p2 }} <br> {{ community[1].p3 }}</p>
                     </div>
                </div>
                
                <div class="col-xl-4 text-center">
                   <div class="community__card shadow-sm">
                    <img :src="community[2].icon" alt="community-icon">
                        <h3>{{ community[2].h3one }} <br> {{ community[2].h3two }}</h3>
                        <p>{{ community[2].p1 }} <br> {{ community[2].p2 }} <br> {{ community[2].p3 }} <br> {{ community[2].p4 }}</p>
                   </div>
                </div>
                <div class="col-xl-4 text-center">
                  <div class="community__card shadow-sm">
                    <img :src="community[3].icon" alt="community-icon">
                        <h3>{{ community[3].h3one }} <br> {{ community[3].h3two }}</h3>
                        <p>{{ community[3].p1 }} <br> {{ community[3].p2 }} <br> {{ community[3].p3 }}</p>
                  </div>
                </div>
            </div>
    ...
    <section class="pixelgrade">
        <div class="container">
          <div class="row">
            <div class="col-xl-5">
              <img class="img-fluid" :src="pixelgrade.icon" :alt="pixelgrade.alt" :title="pixelgrade.title">
            </div>
            <div class="col-xl-7">
              <div class="pixelgrade__content">
    ...
    <section class="local">
        <div class="container">
          <div class="row">
            <div class="col-xl-6 local__content">
              <h2>{{ local[0].h2one }} <br> <span> {{ local[0].h2two }} </span> </h2>
              <p>{{ local[0].p }}</p>
            </div>
                ...
                <div class="col-xl-12">
                  <div class="row my-sm-5 ">
                    <div class="col-xl-6">
                      <div class="d-flex">
                        <div class="members">
                          <img :src="local[1].icon" :alt="local[1].alt" :title="local[1].title">
                        </div>
                        <div class="members__number">
                          <h3>{{ local[1].h3 }}</h3>
                          <span>{{ local[1].span }}</span>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-6">
                      <div class="d-flex">
                        <div class="members">
                          <img :src="local[2].icon" :alt="local[2].alt" :title="local[2].title">
                        </div>
                        <div class="members__number">
                          <h3>{{ local[2].h3 }}</h3>
                          <span>{{ local[2].span }}</span>
                        </div>
                      </div>
                ...
                <div class="col-xl-12">
                  <div class="row">
                    <div class="col-xl-6">
                      <div class="d-flex">
                        <div class="members">
                          <img :src="local[3].icon" :alt="local[3].alt" :title="local[3].title">
                        </div>
                        <div class="members__number">
                          <h3>{{ local[3].h3 }}</h3>
                          <span>{{ local[3].span }}</span>
                        </div>
                      </div>
                    ...
                    <div class="col-xl-6">
                      <div class="d-flex">
                        <div class="members">
                          <img :src="local[4].icon" :alt="local[4].alt" :title="local[4].title">
                        </div>
                        <div class="members__number">
                          <h3>{{ local[4].h3 }}</h3>
                          <span>{{ local[4].span }}</span>
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <section class="site">
        <div class="container">
          <div class="row">
            <div class="col-xl-5">
              <img class="img-fluid" :src="site.icon" :alt="site.alt" :title="site.title">
            </div>
            <div class="col-xl-7">
              <h2>{{ site.h2one }} <br/> {{ site.h2two }}</h2>
              <p>{{ site.p }}</p>
              <button class="btn btn-primary">{{ site.learn }}</button>
            </div>
          </div>
        </div>
    </section>
    ...
    <section class="tim">
        <div class="container">
          <div class="row">
            <div class="col-xl-4">
              <img :src="tim[0].icon" :alt="tim[0].alt" :title="tim[0].title">
            </div>
            <div class="col-xl-8">
              <p>{{ tim[0].p }}</p>
              <h4>{{ tim[0].h4 }}</h4>
              ...
              <div class="tim_s d-flex">
                <img :src="tim[1].logo" :alt="tim[1].alt" :title="tim[1].title">
                <img :src="tim[1].logo1" :alt="tim[1].alt" :title="tim[1].title">
                <img :src="tim[1].logo2" :alt="tim[1].alt" :title="tim[1].title">
                <img :src="tim[1].logo3" :alt="tim[1].alt" :title="tim[1].title">
                <img :src="tim[1].logo4" :alt="tim[1].alt" :title="tim[1].title">
                <img :src="tim[1].logo5" :alt="tim[1].alt" :title="tim[1].title">
                <a href="#"> {{ tim[1].link }}  <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="24/Arrows &#38; Directions/Right">
<g id="Right">
<path id="Vector" d="M16.4999 16.399L19.7928 13.1062C20.1834 12.7156 20.1834 12.0825 19.7928 11.6919L16.4999 8.39905M19.4999 12.399L5.49994 12.399" stroke="#4CAF4F" stroke-width="1.5" stroke-linecap="round"/>
</g>
</g>
</svg></a>
              </div>
    ...
    <section class="market">
        <div class="container">
          <h2 class="text-center">{{ marketing[0].h2 }}</h2>
          <p> {{ marketing[0].pone }} <br> {{ marketing[0].ptwo }}  <br> {{ marketing[0].pthree }} ​</p>

          <div class="row gy-5">
            <div class="col-xl-4">
              <img :src="marketing[1].icon" :alt="marketing[1].alt" :title="marketing[1].title">
              <div class="mark_div">
                <p> {{ marketing[1].pone }} <br> {{ marketing[1].ptwo }}  <br> {{ marketing[1].pthree }} </p>
                <a href="#"> {{ marketing[1].read }} <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="24/Arrows &#38; Directions/Right">
<g id="Right">
<path id="Vector" d="M16.4999 16.399L19.7928 13.1062C20.1834 12.7156 20.1834 12.0825 19.7928 11.6919L16.4999 8.39905M19.4999 12.399L5.49994 12.399" stroke="#4CAF4F" stroke-width="1.5" stroke-linecap="round"/>
</g>
            ...
            <div class="col-xl-4">
              <img :src="marketing[2].icon" :alt="marketing[2].alt" :title="marketing[2].title">
              <div class="mark_div">
                <p> {{ marketing[2].pone }} <br> {{ marketing[2].ptwo }} <br> {{ marketing[2].pthree }} </p>
                <a href="#"> {{ marketing[2].read }} <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="24/Arrows &#38; Directions/Right">
<g id="Right">
<path id="Vector" d="M16.4999 16.399L19.7928 13.1062C20.1834 12.7156 20.1834 12.0825 19.7928 11.6919L16.4999 8.39905M19.4999 12.399L5.49994 12.399" stroke="#4CAF4F" stroke-width="1.5" stroke-linecap="round"/>
</g>
            ...
            <div class="col-xl-4">
              <img :src="marketing[3].icon" :alt="marketing[3].alt" :title="marketing[3].title">
              <div class="mark_div">
                <p> {{ marketing[3].pone }} <br> {{ marketing[3].ptwo }}   <br> {{ marketing[3].pthree }} </p>
                <a href="#"> {{ marketing[3].read }} <svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="24/Arrows &#38; Directions/Right">
<g id="Right">
<path id="Vector" d="M16.4999 16.399L19.7928 13.1062C20.1834 12.7156 20.1834 12.0825 19.7928 11.6919L16.4999 8.39905M19.4999 12.399L5.49994 12.399" stroke="#4CAF4F" stroke-width="1.5" stroke-linecap="round"/>
</g>
    ...
    <section class="demo">
        <div class="container text-center">
          <h2> {{ demo.h2one }} <br> {{ demo.h2two }} </h2>
            <button class="btn btn-primary"> {{ demo.learn }} </button>
        </div>
    </section>
    <!-- Demo End -->
    ...
    <Section class="footer">
        <div class="container">
          <div class="row">
            <div class="col-xl-5">
              <h3><img :src="footer[0].icon" :alt="footer[0].alt" :title="footer[0].title"><span> </span></h3>
              <p> {{ footer[0].pone }} <br> {{ footer[0].ptwo }} </p>

              <div class="d-flex footer_brand">
                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
            ...
            <div class="col-xl-7">
              <div class="row">
                <div class="col-xl-4 footer_content">
                  <h4> {{ footer[1].h4 }} </h4>
                  <div class="footer_left">
                    <span> <a href="#"> {{ footer[1].about }} </a> </span>
                    <span> <a href="#"></a> {{ footer[1].blog }} </span>
                    <span> <a href="#"></a> {{ footer[1].contact }} </span>
                    <span> <a href="#"></a> {{ footer[1].pricing }} </span>
                    <span> <a href="#"></a> {{ footer[1].testimonials }} </span>
                  </div>
                </div>
                ...
                <div class="col-xl-4 footer_content">
                  <h4> {{ footer[2].h4 }} </h4>
                  <div class="footer_left">
                    <span> <a href="#"> {{ footer[2].helpcenter }} </a> </span>
                    <span> <a href="#"></a> {{ footer[2].termsofservice }} </span>
                    <span> <a href="#"></a> {{ footer[2].legal }} </span>
                    <span> <a href="#"></a> {{ footer[2].privacypolicy }} </span>
                    <span> <a href="#"></a> {{ footer[2].status }} </span>
                  </div>
                </div>
